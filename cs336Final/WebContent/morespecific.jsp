...
<b><font color = "navy"><font size = "+6">Digging Deeper into the U.S.</font></b></font>
...
<form method="get" action="averageview.jsp" enctype=text/plain>
	...
	<br>
	<mark>Want to see how your state's values match up against average values for all states? Or some extreme values?</mark>
