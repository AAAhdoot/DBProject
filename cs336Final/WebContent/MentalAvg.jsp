	...
	<%
		...
		Connection con = DriverManager.getConnection(url, "arielashni", "lelohex69");
			...
			if(table.equals("StateInfo")){
				...
				str = "SELECT " + table_result + " FROM " + table + equals + "  StateInfo.Mental_Health_Access <= 13 AND Mental_Health_Access>=1;";
				str2 = "SELECT " + table_result + " FROM " + table + equals + "  StateInfo.Mental_Health_Access <= 26 AND Mental_Health_Access>=14;";
				str3 = "SELECT " + table_result + " FROM " + table + equals + "  StateInfo.Mental_Health_Access <= 38 AND Mental_Health_Access>=27;";	
				str4 = "SELECT " + table_result + " FROM " + table + equals + "  StateInfo.Mental_Health_Access <= 51 AND Mental_Health_Access>=39;";
